...
/// 图标与标签随选中态切换颜色。
class NexusNavigationBar extends StatelessWidget {
  const NexusNavigationBar({
    super.key,
  ...
  final List<NexusNavigationDestination> destinations;
  final double height;
...
class NexusNavigationDestination {
  const NexusNavigationDestination({
    required this.icon,
    required this.label,
    this.selectedIcon,
  });
