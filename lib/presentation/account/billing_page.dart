...
class _BillingPageState extends ConsumerState<BillingPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final access =
          await ref.read(accountServiceProvider).accessTokenOrThrow();
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('充值成功：${_tiers[cents] ?? '¥${cents / 100}'}')));
      }
    } catch (e) {
      if (mounted) {
        setState(() {
        ...
        child: ListView(
          ...
          children: [
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      if ((_balance?.balanceCents ?? 0) <
                          ref.watch(remoteConfigServiceProvider).intFlag(
                              'billing.balance_warning_min_cents', 500))
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: const Text('余额较低，请及时充值以免影响使用',
            ...
            if (ref
                ...
                .boolFlag('subscription.monthly_1990', false)) ...[
              const SizedBox(height: 16),
              const Divider(),
              ListTile(
